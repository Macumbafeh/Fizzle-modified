...
local function getOptions()
	local options = {
		...
		args = {
			...
			gem = {
				name = L["Hide gem Text"],
				desc = L["Hide gem stats text."],
				type = "toggle",
				order = 700,
				width = "full",
				get = function() return db.HideGemText end,
				set = function() db.HideGemText = not db.HideGemText end,
			},
			enchant = {
				name = L["Hide enchant Text"],
				desc = L["Hide enchant stats text."],
				type = "toggle",
				order = 800,
				width = "full",
...
local enchantAttributes = {
	...
	["2567"] = "+20 Spi",
	["2568"] = "+22 Intel",
	["2583"] = "+10 Def/+10 Stam/+15 Block Value",
	["2584"] = "+7 Def, +10 Stam, +24 Heal",
	["2585"] = "+28 AP/+12 Dodge",
	["2586"] = "+24 Ranged AP, +10 Stam, +10 Hit",
	["2587"] = "+13 Heal & +15 Intel",
	["2588"] = "+18 Heal & +8 Sp.Hit",
	["2589"] = "+18 Heal & +10 Stam",
	["2590"] = "+4 MP5/+10 Stam/+24 Heal",
	["2591"] = "+10 Intel/+10 Stam/+24 Heal",
	["2603"] = "Eternium Line",
	["2604"] = "+33 Heal",
	["2605"] = "+18 SP",
	["2606"] = "+30 AP",
	...
	["2743"] = "+4 Def & +6 Stam",
	["2744"] = "+4 Intel & +2 MP5",
	["2745"] = "+46 Heal & +15 Stam",
	["2746"] = "+66 Heal & +20 Stam",
	["2747"] = "+25 SP & +15 Stam",
	["2748"] = "+35 SP & +20 Stam",
	["2749"] = "+12 Intel",
	["2750"] = "6 MP5",
	...
	["2760"] = "+3 Sp.Crit & +4 SP ",
	["2761"] = "+4 Sp.Crit & +5 SP",
	["2762"] = "+3 Sp.Crit & +4 Spell Pene",
	["2763"] = "+4 Sp.Crit & +5 Spell Pene",
	["2764"] = "+8 Hit",
	["2765"] = "+10 Spell Pene",
	["2766"] = "+8 Intel",
	["2767"] = "+8 Sp.Hit",
	...
	["2825"] = "+$i AP",
	["2826"] = "+$i Block",
	["2827"] = "+14 Sp.Crit & 1% Spell Reflect",
	["2828"] = "Chance to Increase Spell Cast Speed",
	["2829"] = "+24 AP & Minor Speed",
	["2830"] = "+12 Crit& 5% Snare & Root Resist",
	["2831"] = "+18 Stam& 5% Stun Resist",
	["2832"] = "+26 Heal & 2% Reduced Threat",
	["2833"] = "+12 Def& +Chance Restore Health",
	...
	["2937"] = "+20 SP",
	["2938"] = "+20 Spell Pene",
	["2939"] = "Minor Speed & +6 Agi",
	["2940"] = "Minor Speed & +9 Stam",
	["2941"] = "+2 Hit",
	["2942"] = "+6 Crit",
	["2943"] = "+14 AP",
	["2944"] = "+14 AP",
	...
	["2993"] = "+6 MP5 & +22 Heal",
	["2994"] = "+13 Sp.Crit",
	["2995"] = "+15 Sp.Crit & +12 SP",
	["2996"] = "+13 Crit",
	["2997"] = "+15 Crit & +20 AP",
	["2998"] = "+7 All Resists",
	["2999"] = "+16 Def & +17 Dodge",
	["3000"] = "+18 Stam, +12 Dodge, & +12 Resi",
	["3001"] = "+35 Heal & 7 MP5",
	["3002"] = "+22 SP & +14 Sp.Hit",
	["3003"] = "+34 AP & +16 Hit",
	["3004"] = "+18 Stam & +20 Resi",
	...
	["3044"] = "Rockbiter 8",
	["3045"] = "+5 Str & +6 Stam",
	["3046"] = "+11 Heal & +4 Intel",
	["3047"] = "+6 Stam & +5 Sp.Crit",
	["3048"] = "+5 Agi & +6 Stam",
	["3049"] = "+5 Crit & +2 MP5",
	["3050"] = "+6 SP & +4 Intel ",
	["3051"] = "+11 Heal & +6 Stam",
	...
	["3056"] = "+5 Parry & +4 Def",
	["3057"] = "+5 Str & +4 Hit",
	["3058"] = "+5 Sp.Crit & 2 MP5",
	["3059"] = "Sp.Crit+5 & 2 MP5",
	["3060"] = "+5 Dodge & +6 Stam",
	["3061"] = "+6 SP & +5 Sp.Hit",
	["3062"] = "+6 Crit & +5 Dodge",
	["3063"] = "+5 Parry & +6 Stam",
	...
	["3086"] = "+11 Heal & 2 MP5",
	["3087"] = "+5 Str & +4 Resi",
	["3088"] = "+5 Sp.Hit & +6 Stam",
	["3089"] = "+5 Sp.Hit & 2 MP5",
	["3090"] = "+5 Parry & +4 Resi",
	["3091"] = "+5 Sp.Crit & +5 Spell Pene",
	["3092"] = "+3 Crit",
	["3093"] = "+150 AP vs Undead & Demons",
	["3094"] = "+4 Expertise ",
	["3095"] = "+8 Resist All",
	["3096"] = "+17 Str & +16 Intel",
	["3097"] = "+2 Spi",
	["3098"] = "+4 Heal",
	["3099"] = "+6 SP & +6 Stam",
	["3100"] = "+11 Heal & +6 Stam",
	...
	["3139"] = "+5 Crit & +5 Str",
	["3140"] = "+5 Sp.Crit & +6 SP",
	["3141"] = "+11 Heal & +5 Intel",
	["3142"] = "+5 Hit & +5 Agi",
	["3143"] = "+5 Sp.Hit & +6 SP",
	["3144"] = "+5 Crit & +10 AP",
	["3145"] = "+5 Def & +7 Stam",
	["3146"] = "+5 Sp.Crit & +6 Spell Pene",
	["3147"] = "+5 Intel & +2 MP5",
	["3148"] = "+5 Crit & +7 Stam",
	["3149"] = "+2 Agi",
	["3150"] = "+6 MP5",
	...
	["3152"] = "+2 Sp.Crit",
	["3153"] = "+2 SP",
	["3154"] = "+12 Agi & 3% Increased CritDamage",
	...
	["3270"] = "+8 Sp.Haste",
	["3271"] = "+4 Sp.Haste & +5 SP",
	["3272"] = "+4 Sp.Haste & +6 Stam",
	["3273"] = "Deathfrost",
	["3274"] = "+12 Def & +10% Shield Block",
	["3275"] = "+14 SP & +2% Intel",
	["3280"] = "+4 Dodge & +6 Stam",
	["3281"] = "+20 AP",
	["3282"] = "+12 SP",
